    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-10 font-medium">
          <a href="#inicio" className="text-gray-300 hover:text-blue-400 transition-colors text-sm uppercase tracking-widest">Início</a>
          <a href="#empresa" className="text-gray-300 hover:text-blue-400 transition-colors text-sm uppercase tracking-widest">Empresa</a>
          <a href="#servicos" className="text-gray-300 hover:text-blue-400 transition-colors text-sm uppercase tracking-widest">Serviços</a>
          <a href="#fundador" className="text-gray-300 hover:text-blue-400 transition-colors text-sm uppercase tracking-widest">Fundador</a>
        </nav>
