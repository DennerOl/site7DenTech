...
const Founder: React.FC = () => {
  ...
  return (
    <section
      id="fundador"
      className="py-32 bg-[#343A40] text-white relative overflow-hidden border-y border-white/5"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="w-full lg:w-3/5 space-y-8">
            <div className="space-y-4">
              <h2 className="text-blue-500 font-bold uppercase tracking-[0.3em] text-sm">
            ...
            <div className="bg-white/5 p-10 rounded-[2.5rem] border border-white/5 backdrop-blur-md relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-8 text-6xl text-white/5 font-black group-hover:text-blue-500/10 transition-colors">
                7
              </div>
              ...
              <p className="mb-10 text-gray-400 text-lg leading-relaxed">
                Possui uma boa qualificação profissional para atender seus
                clientes, unindo visão estratégica de negócio à execução técnica
                impecável.
              </p>
              <ul className="grid sm:grid-cols-2 gap-6">
                {founder.qualifications.map((q, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-4 text-gray-300 hover:text-white transition-colors duration-300"
                  >
                    ...
                    <span className="font-medium text-sm lg:text-base leading-snug">
                      {q}
                    </span>
                  </li>
                ))}
